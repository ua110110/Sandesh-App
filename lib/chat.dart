              ...
              onPressed: () {
                _joinMeeting() async {
                  ...
                  try {
                    ...
                    String gmail = username + "@gmail.com";

                    var options = JitsiMeetingOptions()
                      ..room = peerId
                      ..serverURL = serverUrl
                      ..subject = peerAvatar
                      ..userDisplayName = peerAvatar
                      ..userEmail = gmail
                ...
                final Map<RoomNameConstraintType, RoomNameConstraint>
                    customContraints = {
                  RoomNameConstraintType.MAX_LENGTH:
                      new RoomNameConstraint((value) {
                    return value.trim().length <= 100;
                  }, "Maximum room name length should be 30."),
                  RoomNameConstraintType.FORBIDDEN_CHARS:
                      new RoomNameConstraint((value) {
                    return RegExp(r"[$ۣ]+",
                ...
                void _onConferenceWillJoin({message}) {
                  debugPrint(
                      "_onConferenceWillJoin broadcasted with message: $message");
                }

                void _onConferenceJoined({message}) {
                  debugPrint(
                      "_onConferenceJoined broadcasted with message: $message");
                }

                void _onConferenceTerminated({message}) async {
                  debugPrint(
                      "_onConferenceTerminated broadcasted with message: $message");
                }
        ...
        child: Column(
          children: <Widget>[
            Container(
              ...
              margin: EdgeInsets.only(left: 14.0, top: 5.0, bottom: 5.0),
            ),
            Row(
              children: <Widget>[
                document.data()['type'] == 0
